...
def non_repeat_substring(string):
    ...
    for window_end in range(len(string)):
        ...
        if right_char in char_index_map:
            ...
            # basically, gotta increment the window_start to the next position when encounter repeating character
            window_start = max(window_start, char_index_map[right_char] + 1)

        # insert the 'right_char' into the map when first encounter it
